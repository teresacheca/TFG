...
class ReservasRoutes {
    ...
    config() {
        ...
        this.router.get('/empresas/:id_empresa/lista_administradores/:id', reservasController_1.default.getAdministradorEmpresa);
        this.router.delete('/empresas/:id_empresa/lista_administradores/:id/eliminar', reservasController_1.default.eliminarCuentaAdmiEmpresa);
        this.router.put('/empresas/:id_empresa/lista_administradores/:id', reservasController_1.default.guardarCambiosAdmiEmpresa);
        this.router.get('/empresas/:id_empresa/lista_usuarios', reservasController_1.default.getUsuariosEmpresa);
        this.router.get('/empresas/:id_empresa/lista_usuarios/:nombre_usuario', reservasController_1.default.getUsuarioNombre);
